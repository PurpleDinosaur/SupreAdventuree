    ...
    public partial class TradingScreen : Form
    {
        ...
        private void dgvMyItems_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if(e.ColumnIndex == 4)
            {
                ...
                if(itemBeingSold.ID == World.ITEM_ID_RUSTY_SWORD)
                {
               
                	    DialogResult dialogResult = MessageBox.Show("Are you sure you want to sell " + itemBeingSold.Name, "You sure ? ", MessageBoxButtons.YesNo);
